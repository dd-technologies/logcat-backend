...
router.get('/deviceOverview/:deviceId/:project_code', deviceController.getDeviceOverviewById);
router.post('/about/:project_code', deviceController.addAboutDevice);
router.get('/about/:deviceId', deviceController.getAboutByDeviceId);
router.get('/dynamicDeviceId/:deviceId', deviceController.sendAndReceiveData);
router.put('/assignedDeviceToUser', deviceController.assignedDeviceToUser);
router.get('/getAssignedDeviceByUserId/:userId', deviceController.getAssignedDeviceById);
